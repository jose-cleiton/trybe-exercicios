 ...
 */
const callbackCheca = (numApostado, numSorteado) => {
...
const HOFResultadoSorteio = (numApostado, callbackCheca)=>{
    const numAleatorio = Math.floor(Math.random() *5)+1

    return    callbackCheca(numAleatorio, numApostado)
}

const result = HOFResultadoSorteio(4, callbackCheca)
